...
|---------|------|------|--------|---------------|------------|
| `bwaIndex` | 1d | 1 | `16.GB * task.attempt` | retry | 6 |
| `CleanVCFs` | 1d | 1 | `4.GB * task.attempt` | retry | 3 |
| `ConcatVCFs` | 7d | 1 | `2.GB * task.attempt` | retry | 3 |
| `trimSequencesPE` | 1d | — | `2.GB * task.attempt` | retry→ignore ¹ | 3 |
| `trimSequencesSE` | 1d | 4 | `2.GB * task.attempt` | retry→ignore ¹ | 3 |
| `filterReference` | 1d | 1 | 1 GB | retry | 3 |
...
| `addRG` | 1d | 1 | `4.GB * task.attempt` | retry | 3 |
| `dupRemoval` | 1d | 1 | `4.GB * task.attempt` | retry | 3 |
| `PopGenVCF` | 7d | 1 | 1 GB | retry | 3 |
...
| `RQualPlotting` | 1d | 1 | 16 GB | retry | 3 |
| `PipelineStatistics` | 4h | 1 | 1 GB | retry | 3 |
| `bwaMap` | 7d | — | `8.GB * task.attempt` | retry | 3 |
| `CombineGVCFs` | 7d | 2 | `8.GB * task.attempt` | retry | 3 |
| `ConcatCleanVCFs` | 7d | 1 | `2.GB * task.attempt` | retry | 3 |
| `SRAdownloadPE` | 7d | 1 | 1 GB | retry→ignore ¹ | 4 |
| `SRAdownloadSE` | 7d | 1 | 1 GB | retry→ignore ¹ | 4 |
| `GATKHC` | 7d | 1 | `4.GB * task.attempt` | retry | 3 |
| `GenomicsDBImport` | 7d | 2 | `8.GB * task.attempt` | retry | 3 |
| `GenotypeGVCFs` | 7d | 1 | `4.GB * task.attempt` | retry | 3 |
